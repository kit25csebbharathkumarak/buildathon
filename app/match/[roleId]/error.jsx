  ...
  return (
    <div className="flex min-h-[460px] flex-col items-center justify-center rounded-2xl border border-red-500/30 bg-talent-card p-8 text-center shadow-card-elevated">
      ...
      <div className="mt-6 flex items-center gap-3">
        <button
          onClick={() => reset()}
          className="flex items-center gap-2 rounded-lg bg-talent-teal px-4 py-2 text-xs font-semibold text-talent-bg shadow-glow-teal hover:bg-talent-teal-light transition-all"
        >
